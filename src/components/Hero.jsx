  ...
  return (
    <div className="min-h-screen flex flex-col gap-10 items-center justify-center text-center">
      ...
      <p className="text-sm md:text-base font-light">
        I hereby acknowle dgement that I may become{" "}
      ...
      <button className="px-8 py-4 rounded-md  border-[2px] bg-slate-950 border-blue-500 border-solid  blueShadow duration-200">
        <p>Accept Begin</p>
      </button>
    </div>
  );
